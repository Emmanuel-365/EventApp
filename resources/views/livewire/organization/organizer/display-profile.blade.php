<div x-data="
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8 transition-colors duration-300 ease-in-out">
        ...
        @if ($message)
            <div class="{{ $isSuccess ? 'bg-green-100 dark:bg-green-800 border border-green-400 dark:border-green-700 text-green-700 dark:text-green-100' : 'bg-red-100 dark:bg-red-800 border border-red-400 dark:border-red-700 text-red-700 dark:text-red-100' }} px-4 py-3 rounded relative mb-4" role="alert">
                {{ $message }}
            </div>
        @endif
        ...
        @if ($organizer)
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                {{-- Colonne de gauche: Infos Générales (Lecture seule ou Modifiable) --}}
                <div class="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    @else
                        ...
                        <form wire:submit.prevent="saveProfile" class="col-span-full grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            {{-- Image Upload Section for Pending Profile --}}
                            <div class="col-span-full border-t pt-6 mt-6 border-gray-200 dark:border-gray-700">
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-md"
                                         ...
                                         @drop.prevent="handleDrop($event, 'photoProfil')"> {{-- Utilise la nouvelle fonction handleDrop --}}
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-md"
                                         ...
                                         @dragover.prevent="isDragging = true"
                                         @dragleave.prevent="isDragging = false"
                                         @drop.prevent="handleDrop($event, 'pieceIdentiteRecto')"> {{-- Utilise la nouvelle fonction handleDrop --}}
                                        <div class="space-y-1 text-center">
                                            <div class="mx-auto h-12 w-12 text-gray-400 flex items-center justify-center">
                                                <svg class="h-full w-full" stroke="currentColor" fill="none" viewBox="0 0 48 48" aria-hidden="true">
                                                    <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4m32-4V12a4 4 0 00-4-4H12a4 4 0 00-4 4v20m32-4v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-md"
                                         ...
                                         @dragover.prevent="isDragging = true"
                                         @dragleave.prevent="isDragging = false"
                                         @drop.prevent="handleDrop($event, 'pieceIdentiteVerso')"> {{-- Utilise la nouvelle fonction handleDrop --}}
                                        <div class="space-y-1 text-center">
                                            <div class="mx-auto h-12 w-12 text-gray-400 flex items-center justify-center">
                                                <svg class="h-full w-full" stroke="currentColor" fill="none" viewBox="0 0 48 48" aria-hidden="true">
                                                    <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4m32-4V12a4 4 0 00-4-4H12a4 4 0 00-4 4v20m32-4v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    ...
    {{-- CSS pour le flip card et le texte d'affichage --}}
    <style>
        .form-input {
