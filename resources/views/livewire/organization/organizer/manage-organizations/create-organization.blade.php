    ...
    <div class="bg-white dark:bg-gray-800 shadow-xl rounded-lg p-6 sm:p-8 w-full max-w-3xl relative"
        ...
        <form wire:submit.prevent="createOrganization" class="space-y-6">
            <div>
                ...
                @error('nom') <span class="text-red-600 text-sm mt-1 block">{{ $message }}</span> @enderror
            </div>
            ...
            <div>
                ...
                @error('NIU') <span class="text-red-600 text-sm mt-1 block">{{ $message }}</span> @enderror
            </div>
            ...
            <div>
                ...
                <select id="type" wire:model="type" required
                    ...
                    @foreach ($typesEntreprise as $typeOption)
            ...
            <div>
                ...
                <input type="date" id="date_creation" wire:model="date_creation" required
                       class="form-input block w-full rounded-md border-gray-300 shadow-sm
                              ...
                              focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50
                              transition ease-in-out duration-150 p-2.5">
                @error('date_creation') <span class="text-red-600 text-sm mt-1 block">{{ $message }}</span> @enderror
            </div>
            ...
            <div>
                ...
                @error('subdomain') <span class="text-red-600 text-sm mt-1 block">{{ $message }}</span> @enderror
            </div>
