<div x-data="{ show: @entangle('showCreateModal').live }"
        ...
        <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div class="sm:flex sm:items-start">
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                    ...
                    {{-- DÉBUT DE L'AJOUT DU SCROLL ICI --}}
                    <div class="max-h-[60vh] overflow-y-auto pr-2 pb-4"> {{-- Ajustez max-h si nécessaire --}}
                        <form  enctype="multipart/form-data" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                {{-- Lieu de l'événement (maintenant un simple champ texte) --}}
                                ...
                                <div>
                                    ...
                                    @if ($image_file)
                                        <div class="mt-2 flex items-center space-x-2">
                                            ...
                                            <img src="{{ $image_file->temporaryUrl() }}" class="h-20 w-20 object-cover rounded-lg shadow">
                    ...
                    {{-- FIN DE L'AJOUT DU SCROLL --}}
                </div>
            </div>
        </div>
        {{-- Boutons d'action (restent hors du conteneur scrollable) --}}
    ...
    {{-- Retiré : @livewire('employee.manage-events.select-location-modal') --}}
</div>
