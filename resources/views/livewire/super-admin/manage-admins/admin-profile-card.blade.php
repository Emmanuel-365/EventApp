                    ...
                    <form wire:submit.prevent="updateAdmin" class="p-6">
                            ...
                            <div class="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="nom" wire:model.defer="nom"
                                           class="form-input w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100
                                              focus:ring-blue-500 focus:border-blue-500 @error('nom') border-red-500 @enderror">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="prenom" wire:model.defer="prenom"
                                           class="form-input w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100
                                              focus:ring-blue-500 focus:border-blue-500 @error('prenom') border-red-500 @enderror">
                                ...
                                <div>
                                    ...
                                    <input type="email" id="email" wire:model.defer="email"
                                           class="form-input w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100
                                              focus:ring-blue-500 focus:border-blue-500 @error('email') border-red-500 @enderror">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="telephone" wire:model.defer="telephone"
                                           class="form-input w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100
                                              focus:ring-blue-500 focus:border-blue-500 @error('telephone') border-red-500 @enderror">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="pays" wire:model.defer="pays"
                                           class="form-input w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100
                                              focus:ring-blue-500 focus:border-blue-500 @error('pays') border-red-500 @enderror">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="ville" wire:model.defer="ville"
                                           class="form-input w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100
                                              focus:ring-blue-500 focus:border-blue-500 @error('ville') border-red-500 @enderror">
                                    @error('ville') <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p> @enderror
                                </div>

                                {{-- Mot de passe --}}
                                <div class="sm:col-span-2">
                                    <label for="password_display" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Mot de Passe</label>
                                    <div class="relative">
                                        <input type="text" id="password_display"
                                               value="{{ $admin->password ? '********' : 'Non défini' }}"
                                               class="form-input w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 cursor-not-allowed"
                                               readonly>
                                    </div>
                                </div>
                                ...
                                {{-- Passcode --}}
                                <div class="sm:col-span-2">
                                    <label for="passcode_display" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Passcode</label>
                                    <div class="relative">
                                ...
                                <div class="sm:col-span-2">
                                    <label for="password_changed_at" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Dernier changement mot de passe</label>
                                    <div class="relative">
                                ...
                                <div class="sm:col-span-2">
                                    <label for="passcode_reset_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Statut réinitialisation Passcode</label>
                                    <div class="relative">
                        ...
                        <div class="mb-6 border-t pt-6 border-gray-200 dark:border-gray-700">
                            ...
                            <div class="mt-2 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                                ...
                                @empty
                                    <p class="text-gray-500 dark:text-gray-400 col-span-full">Aucun rôle disponible pour le guard '{{ $guardName }}'.</p>
                                @endforelse
                            </div>
