                ...
                <form wire:submit.prevent="createAdmin" class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            @if ($photoProfil)
                                <img src="{{ $photoProfil->temporaryUrl() }}" class="mt-2 h-20 w-20 object-cover rounded-full" alt="Prévisualisation Photo Profil">
                            @endif
                        </div>
                        ...
                        <div>
                            ...
                            @if ($pieceIdentiteRecto)
                                <img src="{{ $pieceIdentiteRecto->temporaryUrl() }}" class="mt-2 h-20 w-auto object-cover rounded-md" alt="Prévisualisation Recto">
                            @endif
                        </div>
                        ...
                        <div>
                            ...
                            @if ($pieceIdentiteVerso)
                                <img src="{{ $pieceIdentiteVerso->temporaryUrl() }}" class="mt-2 h-20 w-auto object-cover rounded-md" alt="Prévisualisation Verso">
                            @endif
                        </div>
