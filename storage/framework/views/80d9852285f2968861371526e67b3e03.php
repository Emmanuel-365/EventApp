...
[$__name, $__params] = $__split('employee.profile-display', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-2632906838-0', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('auth.email-reset-form', ['guard' => 'employee']);

$__html = app('livewire')->mount($__name, $__params, 'lw-2632906838-1', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('auth.password-reset-form', ['guard' => 'employee']);

$__html = app('livewire')->mount($__name, $__params, 'lw-2632906838-2', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('employee.connected-base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MARCAU\PhpstormProjects\EventApp\resources\views/employee/pages/profile.blade.php ENDPATH**/ ?>