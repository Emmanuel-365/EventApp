<div class="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
    <h2 class="text-3xl font-extrabold text-gray-900 dark:text-gray-100 mb-8 text-center">
        Gestion des Organisations  <!--[if BLOCK]><![endif]--><?php if($organizer !== null): ?> de  M/Mme <?php echo e($organizer->nom .' '. $organizer->prenom); ?> <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    </h2>
                ...
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $organizations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $organization): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <button wire:click="openDetailsModal('<?php echo e($organization->id); ?>')"
...
[$__name, $__params] = $__split('admin.manage-organizations.organization-details-modal', ['organizationId' => $selectedOrganizationId]);

$__html = app('livewire')->mount($__name, $__params, 'lw-1112054245-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\Users\MARCAU\PhpstormProjects\EventApp\resources\views/livewire/admin/manage-organizations/admin-organizations-list.blade.php ENDPATH**/ ?>