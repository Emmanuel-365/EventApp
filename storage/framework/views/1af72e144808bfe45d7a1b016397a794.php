...
[$__name, $__params] = $__split('organization.organizer.display-profile',['organizer' => $organizer]);

$__html = app('livewire')->mount($__name, $__params, 'lw-2397344516-0', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('auth.email-reset-form', ['guard' => 'organizer']);

$__html = app('livewire')->mount($__name, $__params, 'lw-2397344516-1', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('auth.password-reset-form', ['guard' => 'organizer']);

$__html = app('livewire')->mount($__name, $__params, 'lw-2397344516-2', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('organization.organizer.connected-base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MARCAU\PhpstormProjects\EventApp\resources\views/organization/organizer/pages/profile.blade.php ENDPATH**/ ?>