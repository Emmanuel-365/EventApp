...
<head>
    ...
    <title>Patron Panel Authentication</title>
...
<header class="bg-blue-600 dark:bg-blue-800 text-white p-4 shadow-md transition-colors duration-300 ease-in-out">
    <div class="container mx-auto flex justify-between items-center">
        <h1 class="text-2xl md:text-3xl font-extrabold text-center flex-grow">Patron Panel Authentication</h1>
...
<?php /**PATH C:\Users\MARCAU\PhpstormProjects\EventApp\resources\views/organization/patron/disconnected-base.blade.php ENDPATH**/ ?>