...
<nav class="bg-white dark:bg-gray-800 shadow-sm transition-colors duration-300 ease-in-out">
    <div class="container mx-auto px-4 py-3 flex justify-between items-center">
        <a href="<?php echo e(route('super-admin.manageAdminsView')); ?>" class="text-2xl font-bold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300">
            Super-Admin
        </a>
...
<?php /**PATH C:\Users\MARCAU\PhpstormProjects\EventApp\resources\views/super-admin/connected-base.blade.php ENDPATH**/ ?>