                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="nom" wire:model.defer="nom"
                                   class="form-input w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100
                                      focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['nom'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div>
                            ...
                            <input type="text" id="prenom" wire:model.defer="prenom"
                                   class="form-input w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100
                                      focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['prenom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div>
                            <label for="email" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Email (optionnel)</label>
                            <input type="email" id="email" wire:model.defer="email"
                                   class="form-input w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100
                                      focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div>
                            ...
                            <input type="text" id="telephone" wire:model.defer="telephone"
                                   class="form-input w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100
                                      focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['telephone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div>
                            ...
                            <input type="text" id="pays" wire:model.defer="pays"
                                   class="form-input w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100
                                      focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['pays'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div>
                            ...
                            <input type="text" id="ville" wire:model.defer="ville"
                                   class="form-input w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100
                                      focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['ville'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div>
                            <label for="photoProfil" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Photo de Profil (optionnel)</label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            <!--[if BLOCK]><![endif]--><?php if($photoProfil): ?>
                                <img src="<?php echo e($photoProfil->temporaryUrl()); ?>" class="mt-2 h-20 w-20 object-cover rounded-full" alt="Prévisualisation Photo Profil">
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </div>

                        
                        <div>
                            <label for="pieceIdentiteRecto" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Pièce d'Identité Recto (optionnel)</label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            <!--[if BLOCK]><![endif]--><?php if($pieceIdentiteRecto): ?>
                                <img src="<?php echo e($pieceIdentiteRecto->temporaryUrl()); ?>" class="mt-2 h-20 w-auto object-cover rounded-md" alt="Prévisualisation Recto">
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </div>

                        
                        <div>
                            <label for="pieceIdentiteVerso" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Pièce d'Identité Verso (optionnel)</label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            <!--[if BLOCK]><![endif]--><?php if($pieceIdentiteVerso): ?>
                                <img src="<?php echo e($pieceIdentiteVerso->temporaryUrl()); ?>" class="mt-2 h-20 w-auto object-cover rounded-md" alt="Prévisualisation Verso">
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </div>

                        
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Attribuer les Rôles</label>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $this->availableRoles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <label for="role-<?php echo e($role->id); ?>" class="flex items-center text-gray-700 dark:text-gray-300">
                                        <input type="checkbox" id="role-<?php echo e($role->id); ?>" value="<?php echo e($role->id); ?>" wire:model.defer="selectedRoles"
                                               class="form-checkbox h-4 w-4 text-blue-600 border-gray-300 dark:border-gray-600 dark:bg-gray-700 rounded
...
<?php /**PATH C:\Users\MARCAU\PhpstormProjects\EventApp\resources\views/livewire/super-admin/manage-admins/create-admin.blade.php ENDPATH**/ ?>