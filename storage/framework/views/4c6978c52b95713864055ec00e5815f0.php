<div>
    ...
    <!--[if BLOCK]><![endif]--><?php if($globalSuccessMessage): ?>
        <div x-data="{ show: true }" x-show="show" x-transition:leave.opacity.duration.1000ms
             x-init="setTimeout(() => { show = false; window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('globalSuccessMessage', null); }, 5000);"
             class="max-w-7xl mx-auto px-4 py-3 rounded relative mb-6 bg-green-100 border border-green-400 text-green-700"
             role="alert">
            <strong class="font-bold">Succès !</strong>
            <span class="block sm:inline"><?php echo e($globalSuccessMessage); ?></span>
            <span class="absolute top-0 bottom-0 right-0 px-4 py-3 cursor-pointer" @click="show = false; window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('globalSuccessMessage', null);">
                ...
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $organizations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $organization): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100">
                            <?php echo e($organization->nom); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                            <?php echo e($organization->NIU); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                            <?php echo e($organization->type); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <button wire:click="$dispatch('openOrganizerOrganizationDetailsModal', { organizationId: '<?php echo e($organization->id); ?>' })"
...
<?php /**PATH C:\Users\MARCAU\PhpstormProjects\EventApp\resources\views/livewire/organization/organizer/manage-organizations/organizations-list.blade.php ENDPATH**/ ?>